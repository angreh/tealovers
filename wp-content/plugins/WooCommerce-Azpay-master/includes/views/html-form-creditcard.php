        ...
        <ul class="inputs">
            ...
            <li>
                ...
                <div class="display-block">
                	...
                	<input type="text" name="azpaylte_cc_form_name" value="" class="azpaylte-cc-form-name" />
                </div>

                <div class="display-block">                	
		            <label>Número do Cartão</label>
		            <input type="text" name="azpaylte_cc_form_number" value="" class="azpaylte-cc-form-number" />		            
                </div>
            ...
            <li>
               ...
               <div class="display-block">
                	...
                	<input type="text" name="azpaylte_cc_form_cvv" value="" size="10" class="azpaylte-cc-form-cvv" />
               </div>               
            </li>
        </ul>
</section>
