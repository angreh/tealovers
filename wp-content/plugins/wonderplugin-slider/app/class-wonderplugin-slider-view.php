...
class WonderPlugin_Slider_View {
	...
	function show_upgrade_to_commercial() {
		...
		<ul class="wonderplugin-feature-list">
			...
			<li><a href="http://www.wonderplugin.com/order/?product=slider<?php if (WONDERPLUGIN_SLIDER_VERSION_TYPE == "L") echo '&ref=lite'; ?>" target="_blank">Upgrade to Commercial Version</a></li>
		</ul>
		<?php
	}
				...
				<div class="welcome-panel-column-container">
					...
					<div class="welcome-panel-column welcome-panel-last">
						...
						<ul>
							...
							<li><a href="http://www.wonderplugin.com/order/?product=slider<?php if (WONDERPLUGIN_SLIDER_VERSION_TYPE == "L") echo '&ref=lite'; ?>" target="_blank" class="welcome-icon welcome-view-site">Upgrade to Commercial Version</a></li>
							<?php } ?>
						</ul>
					</div>
				</div>
	...
	?>
		...
		<tr>
			...
			<td><label><input name='addjstofooter' type='checkbox' id='addjstofooter' <?php echo ($addjstofooter == 1) ? 'checked' : ''; ?> /> Add slider js scripts to the footer</label>
			</td>
		</tr>
		...
		?> <div style="padding-left:10px;padding-top:12px;"> <?php
			if (empty($key)) { ?>
				...
				<tr>
					...
					<td><input name="wonderplugin-slider-key" type="text" id="wonderplugin-slider-key" value="" class="regular-text" /> <input type="submit" name="save-slider-license" id="save-slider-license" class="button button-primary" value="Register License Key"  />
					</td>
				</tr>
				</table>
				</form>
	...
	function print_item()
	{
		...
		<?php
		if (WONDERPLUGIN_SLIDER_VERSION_TYPE !== "C")
			echo '<div class="updated"><p style="text-align:center;">' .((WONDERPLUGIN_SLIDER_VERSION_TYPE == "L") ? 'To unlock all skins': 'To remove the Free Version watermark') . ', please <a href="https://www.wonderplugin.com/order/?product=slider" target="_blank">Upgrade to Commercial Version</a>.</p></div>';
