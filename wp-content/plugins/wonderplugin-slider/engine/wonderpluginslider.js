    ...
    $.fn.ashtml5lightbox = function (options) {
        ...
        inst.clickHandler = function () {
            ...
            if (inst.options.titlestyle == "left" ||
                inst.options.titlestyle == "right")inst.$lightboxBox.css({"width": boxW, "height": boxH}); else {
        ...
        inst.showTitle = function (w, t, description) {
            ...
            var sizeObj = inst.calcElemSize({w: elemW, h: elemH}, true);
        ...
        inst.showVideo = function (elem) {
            ...
            inst.resizeLightbox(dataW, dataH, true, function () {
                ...
                if (inst.options.isIE678 || elem[ELEM_TYPE] == 8 || inst.options.isIE9 && inst.options.useflashonie9 || inst.options.isIE10 &&
                    inst.options.useflashonie10 || inst.options.isIE11 && inst.options.useflashonie11)isHTML5 = false; else if (inst.options.isMobile)isHTML5 = true; else if ((inst.options.html5player || !inst.options.flashInstalled) && inst.options.html5VideoSupported)if (!inst.options.isFirefox && !inst.options.isOpera || (inst.options.isFirefox || inst.options.isOpera) && (elem[ELEM_HREF_OGG] || elem[ELEM_HREF_WEBM]))isHTML5 = true;
                if (isHTML5) {
    ...
    $.fn.wonderpluginslider = function (options) {
        ...
        AmazingSlider.prototype = {
            initData: function (onSuccess) {
                ...
                $(".amazingslider-slides", this.container).find("li").each(function () {
                    ...
                    if (img.length > 0) {
                        ...
                        var duration = img.data("duration") ?
                            img.data("duration") : 0;
                        var button = "";
                        if ($("button", $(this)).length > 0)if ($("button", $(this)).parent().is("a"))button = $("button", $(this)).parent().clone().wrapAll("<div/>").parent().html(); else button = $("button", $(this)).clone().wrapAll("<div/>").parent().html();
                        var video = [];
                        if ($("video", $(this)).length > 0) {
                            ...
                            if (videoType == TYPE_VIDEO_MP4)if ($video.data("webm") &&
                ...
                if (this.options.shownumbering)for (var i =
                ...
                if (this.lightboxArray.length > 0) {
                    ...
                    for (i = 0; i < this.lightboxArray.length; i++)this.html5Lightbox.addItem(this.lightboxArray[i][ELEM_LINK], this.lightboxArray[i][ELEM_TITLE],
                        this.options.lightboxnogroup ? "" : "amazingslider" + this.id, this.lightboxArray[i][ELEM_LIGHTBOXWIDTH], this.lightboxArray[i][ELEM_LIGHTBOXHEIGHT], this.lightboxArray[i][ELEM_WEBM], this.lightboxArray[i][ELEM_OGG], this.lightboxArray[i][ELEM_THUMBNAIL], this.lightboxArray[i][ELEM_DESCRIPTION]);
                    var instance = this;
                ...
                if (instance.options.showtimer)$(".amazingslider-timer-" + instance.id, instance.container).css({
                    ...
                    position: "absolute",
                    left: "0px",
                    top: instance.options.timerposition ==
                    "bottom" ? "" : "0px",
                ...
                if (isHTML5) {
                    ...
                    if (videoFile.charAt(0) != "/" && videoFile.substring(0,
                            5) != "http:" && videoFile.substring(0, 6) != "https:")videoFile = this.options.htmlfolder + videoFile;
            ...
            resizeFullscreenImage: function ($imgElem) {
                ...
                if (this.curElem >= 0)this.adjustNav($("#amazingslider-bullet-" +
                this.id + "-" + this.curElem, this.container))
                ...
                if (!this.options.isresponsive) {
                    ...
                    this.container.css({
                        "width": this.options.width, "height": this.options.navdirection == "horizontal" &&
                        this.options.navmultirows ? "auto" : this.options.height
                    })
                } else {
                    this.resizeSlider();
                    var instance = this;
                ...
                if (this.options.navdirection == "vertical") {
                    var len =
                        this.options.navstyle == "none" ? 0 : this.elemArray.length * this.options.navheight + (this.elemArray.length - 1) * this.options.navspacing;
                    if (this.options.navshowbuttons) {
                        if (this.options.navshowarrow) {
                            len += len > 0 ? this.options.navspacing : 0;
                            len += 2 * this.options.navheight + this.options.navspacing
                ...
                $(".amazingslider-bullet-" + this.id, this.container).each(function () {
                    ...
                    if (instance.options.navthumbstyle != "textonly") {
                        $(".amazingslider-bullet-image-" + instance.id, this).css({
                            width: instance.options.navimagewidth + "px", height: instance.options.navimageheight +
                            "px"
                        });
                    ...
                    if (instance.options.navthumbstyle !=
                        "imageonly")if (instance.options.navthumbstyle == "imageandtitle")$(".amazingslider-bullet-text-" + instance.id, this).css({
                        ...
                        height: instance.options.navimageheight +
                        "px"
                ...
                var w = this.options.navstyle ==
                "thumbnails" ? this.options.navwidth - this.options.navborder * 2 : this.options.navwidth;
                var h = this.options.navstyle == "thumbnails" ? this.options.navheight - this.options.navborder * 2 : this.options.navheight;
                var b = this.options.navdirection == "horizontal" && this.options.navmultirows ? "margin-bottom:" + this.options.navrowspacing + "px;" : "";
                var $bullet = $("<div class='amazingslider-bullet-" + this.id + "' id='amazingslider-bullet-" + this.id + "-" + index + "' style='position:relative;float:" + f + ";" + b + "margin-" + marginF + ":" + spacing +
                "px;width:" + w + "px;height:" + h + "px;cursor:pointer;'></div>");
                ...
                $bullet.hover(function () {
                    ...
                    if (instance.options.navshowpreview) {
                        ...
                        var $previewImages = $(".amazingslider-nav-preview-images-" +
                        instance.id, $preview);
                        if (instance.options.navshowplayvideo) {
                            var $previewPlay = $(".amazingslider-nav-preview-play-" + instance.id, $preview);
                            if (instance.elemArray[bulletIndex][ELEM_VIDEO].length > 0 || instance.elemArray[bulletIndex][ELEM_LINK] && instance.elemArray[bulletIndex][ELEM_LIGHTBOX] && instance.checkVideoType(instance.elemArray[bulletIndex][ELEM_LINK]) > 0)$previewPlay.show(); else $previewPlay.hide()
                        }
                        ...
                        var lv, tv = pos.top + instance.options.navheight / 2 - instance.options.navpreviewheight /
                        ...
                        $(imgLoader).load(function () {
                            var style;
                            if (this.width / this.height <= instance.options.navpreviewwidth / instance.options.navpreviewheight)style = "width:" + instance.options.navpreviewwidth + "px;max-width:" + instance.options.navpreviewwidth + "px;height:auto;margin-top:-" + Math.floor(this.height / this.width * instance.options.navpreviewwidth /
                            2 - instance.options.navpreviewheight / 2) + "px;"; else style = "width:auto;max-width:none;height:" + instance.options.navpreviewheight + "px;margin-left:-" + Math.floor(this.width / this.height * instance.options.navpreviewheight / 2 - instance.options.navpreviewwidth / 2) + "px;";
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    if (this.options.navbuttonshowbgimage &&
                        this.options.navbuttonbgimage)$bullet.css({background: "url('" + this.options.skinsfolder + this.options.navbuttonbgimage + "') no-repeat center top"});
                    $.fn["bulletNormal" + this.id] = function () {
                        $(this).css({
                    ...
                    $(imgLoader).load(function () {
                        ...
                        if (instance.options.navthumbstyle != "textonly") {
                            ...
                            instance.options.navimagewidth + "px;height:" + instance.options.navimageheight + "px;overflow:hidden;'><img class='amazingslider-bullet-img-" + instance.id + "' src='" + instance.elemArray[index][ELEM_THUMBNAIL] + "' style='" + style + "' /></div>");
                            ...
                            instance.options.navimagewidth + "px;height:" + instance.options.navimageheight + "px;" + 'background:url("' + instance.options.skinsfolder + instance.options.navplayvideoimage + '") no-repeat center center;' + "' ></div>")
                        }
                        if (instance.options.navthumbstyle != "imageonly") {
                            var thumbtitle = "<div class='amazingslider-bullet-text-" + instance.id + "' style='display:block;position:absolute;overflow:hidden;";
                            if (instance.options.navthumbstyle == "imageandtitle")thumbtitle += "margin-left:0px;margin-top:" + instance.options.navimageheight +
                ...
                if (instance.options.navdirection ==
                    ...
                    if (instance.options.navshowfeaturedarrow) {
                        ...
                        if ($featuredarrow.is(":visible"))$featuredarrow.stop(true,
                            true).animate({left: l + "px"}); else $featuredarrow.css({display: "block", left: l + "px"})
                    }
                    ...
                    if (instance.options.navshowfeaturedarrow) {
                        ...
                        if ($featuredarrow.is(":visible"))$featuredarrow.stop(true,
                            true).animate({top: t + "px"}); else $featuredarrow.css({display: "block", top: t + "px"})
                    }
                ...
                if (this.isAnimating) {
                    ...
                    if (this.options.borderradius > 0)imageCodes += "border-radius:" + this.options.borderradius + "px;-moz-border-radius:" +
                    this.options.borderradius + "px;-webkit-border-radius:" + this.options.borderradius + "px;";
                    imageCodes += "' src='" + this.elemArray[savedCur][ELEM_SRC] + "' /></div>";
                    $(".amazingslider-img-box-" + this.id, this.container).html(imageCodes);
                    this.isAnimating = false
                }
                if (this.elemArray[this.curElem][ELEM_TEXTEFFECT] && this.elemArray[this.curElem][ELEM_TEXTEFFECT].length > 0 && "textformat"in this.options && this.elemArray[this.curElem][ELEM_TEXTEFFECT]in this.options["textformat"])this.textoptions = $.ASUpdateObject(this.textoptions,
                    this.options["textformat"][this.elemArray[this.curElem][ELEM_TEXTEFFECT]]); else this.textoptions = $.ASUpdateObject(this.textoptions, this.options);
                this.sliderTimeout.stop();
                ...
                (new Image).src =
                    this.elemArray[this.prevElem][ELEM_SRC];
                ...
                $(imgLoader).load(function () {
                    ...
                    var imgCurCodes =
                        "<div class='amazingslider-img-" + instance.id + "' style='display:block;position:absolute;left:0px;top:0px;width:100%;height:100%;overflow:hidden;'>";
                    ...
                    } else instance.curImageMarginTop = -1 * (imgRatio - sliderRatio) * 50; else if (instance.options.scalemode == "fit")instance.curImageMarginTop =
                        (sliderRatio - imgRatio) * 50; else {
        ...
        this.each(function () {
            ...
            if ($(this).data("textformat") && typeof WONDERPLUGIN_SLIDER_TEXT_EFFECT_FORMATS !== "undefined")if ($(this).data("textformat")in WONDERPLUGIN_SLIDER_TEXT_EFFECT_FORMATS)this.options = $.extend({}, WONDERPLUGIN_SLIDER_TEXT_EFFECT_FORMATS[$(this).data("textformat")],
                this.options);
            ...
            var defaultOptions = {
                ...
                kenburns: {
                    ...
                    scale: 1.1, easing: "easeOutCubic", checked: true
                },
                threedhorizontal: {
                    checked: true,
                    effectdirection: 0,
                ...
                blinds: {
                    duration: 1500,
                    easing: "easeOutCubic", checked: true, effectdirection: 0, slicecount: 5
                },
                threedflip: {
                    duration: 1500,
                    easing: "ease-out",
                ...
                wimagedefault: "",
                wposcss: "display:none !important;position:absolute;top:6px;left:6px;visibility:visible !important;z-index:999999 !important;", //hack para remover a marca d'água
...
(function ($) {
                    ...
                    switch (direction) {
                        case 0:
                            context.drawImage(image,
                                l0, t0, w0, h0, w - scale * w, h - scale * h, scale * w, scale * h);
                            break;
                        case 1:
    ...
    $.fn.sliceTransition = function (id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        if (!options.direction)slices =
            $($.makeArray(slices).reverse());
        var effects = options.effects.split(",");
    ...
    $.fn.blindsTransition = function (id, $prev, $next, options,
