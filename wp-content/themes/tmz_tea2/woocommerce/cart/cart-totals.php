...
<!--	<h2>--><?php //_e( 'Cart Totals', 'woocommerce' ); ?><!--</h2>-->
	...
	<table cellspacing="0" class="shop_table_responsive tmz-woo-carrinho-total">

		<tr class="cart-subtotal">
			<th colspan="2">
                <span class="tmz-woo-subtotal-titulo"><?php _e( 'Subtotal:', 'woocommerce' ); ?></span>
                <span class="tmz-woo-subtotal-valor"><?php wc_cart_totals_subtotal_html(); ?></span>
            </th>
		</tr>
		...
		<tr class="order-total">
			<th colspan="2">
                <span class="tmz-woo-total-titulo"> <?php _e( 'Valor total:', 'woocommerce' ); ?></span>
                <span class="tmz-woo-total-valor"><?php wc_cart_totals_order_total_html(); ?></span>
            </th>
		</tr>
